...
// $_SESSION['student_username'] = "testustuuser";
// $_SESSION['student_email'] = "teststuuser@example.com";
// $_SESSION['student_doj'] = "27 November 2024"
...
if (isset($_SESSION['username'])) {
    ...
    $stmt = $conn->prepare("SELECT student_email, student_doj FROM student WHERE student_username = ?");
        ...
        <div class="profile-container">
            ...
            <form class="profile-form" action="Profile-Admin.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <!-- <input type="text" id="doj" name="doj" value="<?php echo $_SESSION['student_doj']; ?>" required> -->
                </div>
