<!-- This is just a design for upload file later might need to use for Admin and Educator -->
...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        foreach ($_FILES as $file) {
            if ($file['error'] === UPLOAD_ERR_OK) {
                ...
                // Optional: Add more validation or rename the file to prevent overwriting
    ...
    <div class="modal">
        ...
        <div class="modal-footer">
            ...
            <button class="btn-primary" id="uploadButton">Upload File</button>
        </div>
    </div>

    <script src="FilesPg.js"></script>
</body>
